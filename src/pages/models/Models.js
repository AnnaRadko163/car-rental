              ...
              <div className='models__box'>
                <div className='models-item'>
                  ...
                  <div className='models-item__descr'>
                    <div className='models-item__title-price'>
